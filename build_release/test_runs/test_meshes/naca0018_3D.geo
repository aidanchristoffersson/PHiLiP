...
//+
Transfinite Curve {1026, 1028, 1029, 1039} = n_chord_rear_BL Using Progression 1;
//+
Transfinite Curve {1114, 1118} = n_chordwise_BL + n_chord_rear_BL - 1 Using Progression 1;
//+
// Wake
//+
Transfinite Curve {1073, 1113} = n_near_wake_0 + 1- n_chordwise_TES Using Progression 1;
//+
Transfinite Curve {1112, 1074} = n_chordwise_TES Using Progression r_wake_BL_chord;
//+
...
//+
Physical Surface("Airfoil", 1001) = {1197, 1290, 1223, 1245, 1267};
//+
